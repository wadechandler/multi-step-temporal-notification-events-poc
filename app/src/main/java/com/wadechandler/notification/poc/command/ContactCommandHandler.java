...
public class ContactCommandHandler {
    ...
    @KafkaListener(topics = KafkaConfig.CONTACT_COMMANDS_TOPIC)
    public void handle(String message) throws Exception {
        ...
        if (existing.isPresent()) {
            ...
            kafkaTemplate.send(KafkaConfig.CONTACT_EVENTS_TOPIC, existingContact.getId().toString(), contactJson);
            return;
        }
        ...
        kafkaTemplate.send(KafkaConfig.CONTACT_EVENTS_TOPIC, contact.getId().toString(), contactJson);
